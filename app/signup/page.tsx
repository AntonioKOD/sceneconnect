        ...
        <div className='min-h-screen flex items-center justify-center bg-gray-100'>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(handleSignup)} className='space-y-4'>
                    ...
                    />
                    <FormDescription className='text-gray-500 text-sm'>Ready to bring your vision to life? <Link href='/creator-signup' className='text-blue-600 font-bold'>Become a creator</Link></FormDescription>
